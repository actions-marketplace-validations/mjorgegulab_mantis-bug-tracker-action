...
## [![Test Code](https://github.com/voidentropy/mantis-bug-tracker-action/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/voidentropy/mantis-bug-tracker-action/actions/workflows/tests.yml) [![CodeQL](https://github.com/voidentropy/mantis-bug-tracker-action/actions/workflows/github-code-scanning/codeql/badge.svg)](https://github.com/voidentropy/mantis-bug-tracker-action/actions/workflows/github-code-scanning/codeql) [![Codacy Badge](https://app.codacy.com/project/badge/Grade/449abb03804c4d2b9cc2cbc4ac256e5e)](https://app.codacy.com/gh/voidentropy/mantis-bug-tracker-action/dashboard?utm_source=gh&utm_medium=referral&utm_content=&utm_campaign=Badge_grade) [![Known Vulnerabilities](https://snyk.io/test/github/voidentropy/mantis-bug-tracker-action/badge.svg)](https://snyk.io/test/github/voidentropy/mantis-bug-tracker-action) [![AI CODE NOT HERE](https://aicodenothere.com/badge.json?size=20)](https://aicodenothere.com/)
...
jobs:
  open-issue:
    ...
    steps:
      - name: 📂 Open issue
        uses: voidentropy/mantis-bug-tracker-action@v1.0.0
        with:
...
_Want another example? Let me know by creating a [github issue](https://github.com/voidentropy/mantis-bug-tracker-action/issues/new)_
...
[<img alt="Bug Tracked With-Mantis Bug Tracker Github Action" src="https://img.shields.io/badge/Bug Tracked With-Mantis Bug Tracker Github Action-<COLOR>?style=for-the-badge&color=0077b6">](https://github.com/voidentropy/mantis-bug-tracker-action)

```md
[<img alt="Bug Tracked With-Mantis Bug Tracker Github Action" src="https://img.shields.io/badge/Bug Tracked With-Mantis Bug Tracker Github Action-<COLOR>?style=for-the-badge&color=0077b6">](https://github.com/voidentropy/mantis-bug-tracker-action)
```

[<img alt="Bug Tracked With-Mantis Bug Tracker Github Action" src="https://img.shields.io/badge/Bug Tracked With-Mantis Bug Tracker Github Action-<COLOR>?style=for-the-badge&color=2b9348">](https://github.com/voidentropy/mantis-bug-tracker-action)

```md
[<img alt="Bug Tracked With-Mantis Bug Tracker Github Action" src="https://img.shields.io/badge/Bug Tracked With-Mantis Bug Tracker Github Action-<COLOR>?style=for-the-badge&color=2b9348">](https://github.com/voidentropy/mantis-bug-tracker-action)
```

[<img alt="Bug Tracked With-Mantis Bug Tracker Github Action" src="https://img.shields.io/badge/Bug Tracked With-Mantis Bug Tracker Github Action-<COLOR>?style=for-the-badge&color=d00000">](https://github.com/voidentropy/mantis-bug-tracker-action)
...
Copyright © Marc Jorge - Released under the MIT License.
